...
export const PLUGIN_VERSION = "0.3.11";
...
export const MANAGED_DAILY_REPORT_CRON_TAG = "[managed-by=memory-lancedb-dreaming] daily-report";
...
export const DREAMING_STATE_RELATIVE_PATH = ["memory", ".dreams", "lancedb-dreaming-state.json"];
